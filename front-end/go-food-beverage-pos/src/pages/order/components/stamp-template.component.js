...
export const StampTemplateComponent = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    render(stampConfig, stampData, isPrintAllItems) {
      renderStampTemplate(stampConfig, stampData, isPrintAllItems);
    },
    print() {
      printTemplate();
    },
  ...
  const renderStampTemplate = (stampConfig, stampData, isPrintAllItems) => {
    ...
    const stampTemplate = buildStampTemplate(stampConfig, newStampData);
