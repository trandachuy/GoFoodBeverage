                ...
                <Row>
                  ...
                  <Col span={12}>
                    {products && products.length > 0 && (
                      <div className="float-right d-flex clear-all-item" onClick={clearAllItems}>
                ...
                <Row>
                  <Col span={12} className="text-discount">
                    ...
                    {isDiscountOnTotal && totalDiscountAmount > 0 && (
                      <span className="label-discount-total">{formatCurrency(totalDiscountAmount)}</span>
                    )}
                  </Col>
                  <Col span={12} className="price price-discount">
              ...
              <div className="total">
                <Row>
                  ...
                  <Col span={12} className="price price-total">
                    {currentOrderType?.id === OrderTypeStatus.InStore ||
                    currentOrderType?.id === OrderTypeStatus.Delivery
                      ? formatCurrency(totalPriceOnBill + totalTax + totalFee)
                      : formatCurrency(totalPriceOnBill + totalFee)}
                  </Col>
                </Row>
              </div>
