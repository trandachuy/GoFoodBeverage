    ...
    <>
      ...
      <FnbPageHeader
        ...
        actionButtons={[
          ...
          {
            action: <CancelButton buttonText={translateData.button.stop} onOk={() => setShowConfirmStop(true)} />,
            permission: isStop ? " " : PermissionKeys.STOP_QR_CODE,
          },
          {
            action: <CancelButton buttonText={translateData.button.delete} onOk={() => setShowConfirmDelete(true)} />,
