...
namespace GoFoodBeverage.POS.Application.Features.Orders.Commands
{
    ...
    public class CreateOrderRequestHandler : IRequestHandler<CreateOrderRequest, CreateOrderResponse>
    {
        ...
        public async Task<CreateOrderResponse> Handle(CreateOrderRequest request, CancellationToken cancellationToken)
        {
            ...
            var saveResult = await SaveOrderAsync(calculatingCartItemsResult, newCartItems, loggedUser, request, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var result = await UpdateOrderAsync(calculatingCartItemsResult, cartItems, loggedUser, request, cancellationToken);
